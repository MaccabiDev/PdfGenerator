...
const extractValues = (testValues)=>{
    
        var values =  testValues.map((val, index)=>{
        ...
        <div class="font12 medium colorBlack col30 floatRight testNameFontWeight" style="direction:ltr;">${val.test_desc}</div>
...
module.exports.createHeader = function(headerData){
            ...
            <div style=" width: 100%; float: right;">
                <div style="float: right;">
                    <h2 style="font-size: 16px; font-weight: 500; color: #141414;" class="medium">תוצאות בדיקות מעבדה עבור - ${headerData.first_name_hebrew + " " + headerData.last_name_hebrew}</h2>
                    <div style="width: 100%; float: right;">
                ...
                <h3 style="margin-top:5px;font-weight: 500;font-family: MediumFont; font-size: 16px; color: #141414;" >בדיקות שבחרת לעקוב אחריהן</h3>
            </div>
